...
# -*- coding: utf-8 -*-
"""
Created on Sat Oct 27 12:16:49 2018

@author: erikedmonds

My first foray into probablistic programming. Using Uber's Pyro library and 
Torch.

A Bayesian Regression. Learns f(x) of form y=ax+b

Tutorial can be found of Uber's website.
"""
import os
import numpy as np
import torch
...
def linear_not_bayes():
    data = build_linear_dataset(N)
    x_data = data[:, :-1]
    y_data = data[:, -1]
    print("Iterations of a normal linear regression:")
